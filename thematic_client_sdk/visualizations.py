...
class Visualizations(Requestor):
    ...
    def create(self, survey_id, view_id, name, visualization_type, configuration, category=None):
        ...
        fields = {'name': name, 'type': visualization_type,
                  'configuration': configuration, 'category': category}
    ...
    def get(self, survey_id, view_id, vis_id=None):
        ...
        if view_id != None:
            url = '/survey/{}/view/{}/visualizations'.format(
                survey_id, view_id)
    ...
    def update(self, survey_id, view_id, visualization_id, fields):
        ...
        url = self.create_url(self._get_base_url(
            survey_id, view_id, visualization_id))
