...
class Visualizations(object):
    ...
    def get_visualization_url(self,survey_id,visualization_id):
        '''
        Returns the url that can be used to render a visualization. This url still requires the authorization header
        '''
    ...
    def get_visualization_html(self,survey_id,visualization_id):
        ...
        This file will have the access token embedded so can retrieve further information for the lifetime of the token.
