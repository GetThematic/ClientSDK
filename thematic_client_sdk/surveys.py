...
class Surveys(Requestor):
    ...
    def create(self,organization, survey_name, survey_options='{}', is_preview_only=False, manualUploadAllowed=True):
        url = self.api_url + '/survey'
        fields = {'organization': organization, 'name': survey_name, 'configuration': survey_options, 
                  'manualUploadAllowed': True, 'isPreview': is_preview_only}
